...
<head>
    <title>您访问的页面不存在-404.life</title>
    <!-- for-mobile-apps -->
    ...
    <link
            href='http://fonts.useso.com/css?family=Raleway:400,100,100italic,200,200italic,300,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900italic,900'
...
<div class="main">
    ...
    <div class="agile_copy_right">
        <p>Copyright &copy; 2020.Company name All rights reserved.<a target="_blank" href="#">404.life</a></p>
    </div>
</div>
</body>
